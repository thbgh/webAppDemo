/**
 * @Author: THB
 * @Date:   2018-01-15 11:57:06 AM Monday
 * @Filename: index.js
 * @Last modified by:   THB
 * @Last modified time: 2018-02-07 16:15:38 PM Wednesday
 */
...
export default class Test extends React.Component {
    ...
    dataList = [
        {
            ...
            url: 'SxpunpETIwdxNjcJamwB',
            title: 'QQ'
        }
    ].map(obj => ({
        icon: <img src={`https://gw.alipayobjects.com/zos/rmsportal/${obj.url}.png`} alt={obj.title} style={{
                width: 36
            }}/>,
        title: obj.title
    }));
    ...
    showShareActionSheetMulpitleLine = () => {
        ...
        ActionSheet.showShareActionSheetWithOptions({
            ...
            this.setState({
                clicked2: buttonIndex > -1
                    ? data[rowIndex][buttonIndex].title
                    : 'cancel'
            });
        });
    }
